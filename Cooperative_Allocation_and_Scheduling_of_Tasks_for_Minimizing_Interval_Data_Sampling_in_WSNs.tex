...
\begin{figure*}[!t]
\centering
\subfigure[$k\mathrm{=}5$, $r\mathrm{=}2$, the testbed]{\includegraphics[width=0.245\columnwidth]{Figures/evaluation2_data_loss_rate}\label{evaluation2_data_loss_rate}}
\hspace{20pt}\subfigure[$k\mathrm{=}5$, $r\mathrm{=}2$, TOSSIM]{\includegraphics[width=0.245\columnwidth]{Figures/evaluation3_received_data}\label{evaluation3_received_data}}
\hspace{20pt}\subfigure[$k\mathrm{=}5$, $r\mathrm{=}2$, TOSSIM]{\includegraphics[width=0.246\columnwidth]{Figures/evaluation3_data_loss_rate}\label{evaluation3_loss_rate}}
